      ...
      <div className="App" >
        <header className="App-header">
          <div className="popup">
            ...
            <div className="drop-inner" ref={this.dropRef}><h4 style={{ color: "darkcyan" }}>Drop audio file here!</h4></div>

            <div style={{display: "flex", flexDirection: "column", flex: "1", textAlign: "left"}}>
              <label className={!this.state.errorMessage ? 'hidden' : ''} style={{ color: "red"}}>Error: File not supported. Please import .mp3 files only.</label>
